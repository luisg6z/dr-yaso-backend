...
volunteersRouter.get("/:id", authenticate, authorize([tipoUsuarioEnum.enumValues[0]]), getVolunteerByIdHandler);

volunteersRouter.get("/", authenticate, authorize([tipoUsuarioEnum.enumValues[0]]), getAllVolunteersHandler);
...
volunteersRouter.delete("/:id", authenticate, authorize([tipoUsuarioEnum.enumValues[0]]), deleteVolunteerHandler);
